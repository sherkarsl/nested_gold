...
ActiveRecord::Schema.define(version: 20150810082500) do
  ...
  add_index "tasks", ["project_category_id"], name: "index_tasks_on_project_category_id", using: :btree

  add_foreign_key "project_categories", "projects"
  add_foreign_key "tasks", "project_categories"
end
